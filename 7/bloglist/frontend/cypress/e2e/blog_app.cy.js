// liking tests are broken due to changes in code
  ...
  describe("Login", function () {
    ...
    describe("When logged in", function () {
      ...
      it("a new blog can be created", function () {
        ...
        cy.get(".success-notification").should(
          "contain",
          "a new blog Things to do in Stockholm by Stockholm Stad added"
        );
      ...
      describe("and several blogs from different users exist", function () {
        beforeEach(function () {
          ...
          cy.createBlog({
            title: "first super blog",
            author: "FS",
            url: "first.com",
          });
          cy.createBlog({
            title: "second super blog",
            author: "SS",
            url: "second.com",
          });
          cy.logOut();
          ...
          cy.createBlog({
            title: "first normal blog",
            author: "FN",
            url: "first.fi",
          });
        });
        it("user can like any blog", function () {
          cy.contains("first super blog").find(".show-details-button").click();
          cy.contains("first.com")
            .parent()
            .find(".likes")
            .should("contain", "0");
          cy.contains("first.com").parent().find(".like-button").click();
          cy.contains("first.com")
            .parent()
            .find(".likes")
            .should("contain", "1");

          cy.contains("first normal blog").find(".show-details-button").click();
          cy.contains("first.fi")
            .parent()
            .find(".likes")
            .should("contain", "0");
          cy.contains("first.fi").parent().find(".like-button").click();
          cy.contains("first.fi")
            .parent()
            .find(".likes")
            .should("contain", "1");
        ...
        it('only the user who created a blog can see and use its "remove" button', function () {
          ...
          cy.contains("first normal blog").find(".show-details-button").click();
          cy.contains("first.fi").parent().find(".remove-button").click();
        ...
        it("blogs are ordered according to likes (most likes first)", function () {
          cy.contains("first super blog").find(".show-details-button").click();
          cy.contains("second super blog").find(".show-details-button").click();
          cy.contains("first.com")
            .parent()
            .find(".like-button")
            .as("firstLikeButton");
          cy.contains("first.com").parent().find(".likes").as("firstLikes");
          cy.contains("second.com")
            .parent()
            .find(".like-button")
            .as("secondLikeButton");
